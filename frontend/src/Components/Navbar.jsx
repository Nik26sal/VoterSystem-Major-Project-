      ...
      <nav className="w-full bg-white shadow fixed top-0 left-0 z-50">
        <div className="w-full px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 items-center">
            <button onClick={() => navigate("/dashboard/2")} className="hover:text-blue-600">
              Dashboard
            </button>
            <button onClick={() => navigate("/")} className="hover:text-blue-600">
              Events
            </button>
            <button onClick={() => navigate("/profile/1")} className="hover:text-blue-600">
              Profile
            </button>
            <button
      ...
      {open && (
        <div className="fixed top-16 left-0 right-0 bg-white shadow-lg z-50 md:hidden h-screen">
          <div className="flex flex-col p-4 space-y-3">
            <button onClick={() => goTo("/dashboard/2")} className="text-left py-2 hover:text-blue-600">
              Dashboard
            </button>
